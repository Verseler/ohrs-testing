...
const selectDate = (day: number) => {
    ...
    const selectedDate = new Date(
        Date.UTC(currentYear.value, currentMonth.value, day)
    );
...
const isDayDisabled = (day: number): boolean => {
    ...
    return isDateDisabled(
        new Date(Date.UTC(currentYear.value, currentMonth.value, day))
    );
};
    ...
    <div class="relative" ref="pickerRef">
        ...
        >
            <p
                ...
                :class="formattedDate ? 'text-neutral-800' : 'text-neutral-600'"
            >
        ...
        >
            ...
            <!-- Days of week -->
            <div
                class="grid grid-cols-7 gap-1 p-2 text-xs font-medium text-center text-gray-500"
            >
            ...
            <div class="grid grid-cols-7 gap-1 p-2">
                <div
                    ...
                    :key="index"
                    class="flex items-center justify-center h-8 text-xs"
                >
                    <button
                        type="button"
                        v-if="day !== 0"
            ...
            <div class="flex justify-between p-2 border-t">
                <button
                    ...
                    :class="{
                        'cursor-not-allowed opacity-50': disabled || !model,
                    }"
                >
                    Clear
                </button>
